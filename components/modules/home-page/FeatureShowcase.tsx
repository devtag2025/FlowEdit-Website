...
const FeatureShowcase = () => {
  return (
    <Container className="flex flex-col-reverse lg:flex-row items-center justify-center gap-10 lg:gap-20 h-screen">
      <div className="flex flex-col gap-4 text-center lg:text-left">
        ...
        <p className="text-black leading-[150%] max-w-md sm:max-w-108 text-sm sm:text-base md:text-lg mx-auto lg:mx-0">
          ...
          audience engaged and your brand top-of-mind.
        </p>
      </div>
